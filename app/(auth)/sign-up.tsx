...
const SignUp = () => {
  ...
  const handleBackToSignUp = () => {
    // 1. This is the official way to kill the current state in the hook
    signUp?.reset();

    // 2. Clear your local form inputs
    setCode("");
    setEmailAddress("");
    setPassword("");
                ...
                <View className="auth-form">
                  ...
                  >
                    <Text className="text-blue-500 font-semibold">
                      Used the wrong email? Edit details
                    </Text>
                  </Pressable>
                </View>
              </View>
